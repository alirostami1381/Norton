...
bot.sendText(chat_id, msg.id_, 0, 1, nil, '> متن خروج به [ '..id..' ] تغییر کرد', 1, 'html')
end
...
print("\027[" .. rang.b[1] .. ";" .. rang.a[2] .. "m\n کاربر با ایدی [ "..id.." ] درگروه افزوده شد \n\027[00m")
local leave = redis:get('txt'..botid..'left') or 'بای'
bot.sendText(chat_id, msg.id_, 0, 1, nil, leave, 1, 'html')
bot.changeChatMemberStatus(chat_id, botid, 'Left')
print("\027[" .. rang.b[1] .. ";" .. rang.k[2] .. "m\n ربات جوینر از گروه خارج شد \n\027[00m")
end
end
end
